...
SAMPLE = [
    ...
    ("Luca Ferrari",  85, 3, 15, 82, 62, 88, 86, 40, 66, ["CAM", "CM"], [("Incisive Pass", True)]),
    ("Diego Santos",  84, 1,  6, 88, 55, 80, 85, 48, 62, ["RW", "RM"],  [("Technical", False)]),
    ("Yuki Tanaka",   83, 2, 10, 89, 52, 78, 84, 45, 60, ["LW", "LM"],  [("Trickster", False)]),
    ("Omar Haddad",   85, 2, 11, 70, 60, 84, 80, 82, 78, ["CDM", "CM"], [("Interceptor", True)]),
    ("Ben Carter",    84, 1,  7, 72, 45, 80, 76, 80, 80, ["CM", "CDM"], [("Press Proven", False)]),
    ("Marco Rossi",   86, 3, 14, 74, 40, 70, 66, 88, 86, ["CB"],        [("Aerial", True)]),
    ("Sven Johansson",85, 2,  9, 76, 38, 68, 64, 87, 85, ["CB"],        [("Block", False)]),
    ("Paulo Alves",   83, 1,  5, 84, 42, 76, 74, 78, 72, ["RB", "RWB"], [("Bruiser", False)]),
    ("Tom Wright",    82, 1,  4, 85, 40, 74, 73, 77, 70, ["LB", "LWB"], []),
    ("Ivan Petrov",   87, 0,  0, 40, 20, 55, 40, 30, 82, ["GK"],        []),
    # bench-ish depth
    ("Noah Kim",      80, 0,  3, 86, 78, 68, 82, 28, 64, ["ST"],        []),
    ("Ali Reza",      81, 1,  6, 68, 50, 82, 78, 76, 70, ["CM"],        [("Pinged Pass", False)]),
